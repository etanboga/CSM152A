...
# Switches
set_property PACKAGE_PIN V17 [get_ports hard]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hard}]
set_property PACKAGE_PIN V16 [get_ports {two_player}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {two_player}]
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {upLed}]					
...
set_property PACKAGE_PIN L1 [get_ports {downLed}]					
...
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {SCLK2}]					
